...
# ╔═╡ 26868734-ef53-4ac6-958b-cb2326309318
begin
	using PlutoUI
...
# ╔═╡ 09e68443-aec1-422a-8eec-dbf282c8e9e7


# ╔═╡ 1b7ff8b4-682d-4193-bb26-2c4a0925364d
question_box(md"""
Fifth derivative of $\arctan x$ at $x=0$?

$\big(\arctan x\big)'''''\bigg|_{x=0} = Q$

Type the answer:

Q = $(@bind x NumberField(-50:50))

""")

# ╔═╡ 93fed590-0bc8-4609-b445-f2db942f042e
if(x==4*2*3*1)
	correct()
else
	keep_working()
...
# ╔═╡ e773bd8f-2821-4b5f-8c22-e5ebd3ab57d6
answer_box(
md"""
The nth derivative at zero is given by the laylor expansion coefficient
...
manifest_format = "2.0"
project_hash = "dd6bfec071f2698f15a1b912ac6e5146a15cd341"
